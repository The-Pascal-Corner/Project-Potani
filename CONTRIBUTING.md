...
Cài đặt môi trường và công cụ tại [TOOLS.md](./TOOLS.md)

Thực hiện chi tiết quy trình build tại [BUILD.md](./build/BUILD.md)
...
* [Mở một Issue](https://github.com/The-Pascal-Corner/Project-Potani/issues) trên repo này.
* Gửi câu hỏi qua phần [Thảo luận (Discussions)](https://github.com/The-Pascal-Corner/Project-Potani/discussions) của dự án.
